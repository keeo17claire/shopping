...
$month = isset($_POST['txtmonth']) ? GetSQLValueString($_POST['txtmonth'], "text") : date('m');
$year = isset($_POST['txtyear']) ? GetSQLValueString($_POST['txtyear'], "text") : date('Y');


$query_rec_req = sprintf("SELECT requisition_ingredient.ReqID, requisition_ingredient.Date, ingredient.IngtName, user.username, requisition_ingredient.ReqAmount 
...
WHERE MONTH(requisition_ingredient.Date) = %s AND YEAR(requisition_ingredient.Date) = %s", $month, $year);
...
<body>
  <table width="100%" border="0" cellspacing="5" cellpadding="10">
    <tr>
      <td align="center">
        <h3>รายงานการเบิกวัตถุดิบประจำเดือน</h3>
      </td>
    </tr>
